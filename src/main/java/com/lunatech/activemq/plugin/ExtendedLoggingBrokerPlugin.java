...
/**
 * This plugin extends the default {@link LoggingBrokerPlugin} and adds MDC fields before a message
 * is sent to a logging event.
 */
public class ExtendedLoggingBrokerPlugin extends LoggingBrokerPlugin {
  ...
  public void send(ProducerBrokerExchange producerExchange, Message messageSend) throws Exception {
    ...
    if (Optional.fromNullable(producerExchange.getConnectionContext().getUserName())
        .isPresent()) {
    ...
    try {
      ...
      // this should not block the Activemq default process
